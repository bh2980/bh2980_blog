...
저는 sitemap 함수에 게시글과 메모 리스트를 가벼와서 넣어주는 방식으로 작성했는데요. 이렇게 하면 게시글이 추가될 때마다 사이트맵이 함께 갱신되므로, 수동으로 관리할 때 발생할 수 있는 누락 가능성을 줄일 수 있습니다.
...
```svelte title="https://bh2980.dev/sitemap.xml"
