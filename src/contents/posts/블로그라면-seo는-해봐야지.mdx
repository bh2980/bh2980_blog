...
publishedDateTimeISO: 2026-02-13T00:21:00.000Z
tags:
  - blog
  - nextjs
  - seo
...
그동안 CSR 위주로 개발해왔던 터라 SEO를 의식해서 개발해 본 경험이 거의 없었습니다. 그래서 이번에는 블로그를 만들면서, SEO에는 어떤 것들이 있고 역할은 무엇인지, 그리고 Next.js에서 이를 어떻게 적용하는지 정리해보려고 합니다.
...
![](/assets/images/posts/%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%9D%BC%EB%A9%B4-seo%EB%8A%94-%ED%95%B4%EB%B4%90%EC%95%BC%EC%A7%80/%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA%202026-02-12%20%E1%84%8B%E1%85%A9%E1%84%92%E1%85%AE%207.41.00.png)

### 2. metadata

메타데이터는 페이지의 내용을 요약해서 설명하는 데이터입니다. 즉, 본문 내용이 아닌 **검색 엔진이나 브라우저가 페이지를 이해하고 표시하는 데 사용되는 부가 정보**로, 주로 `<head>` 태그 안에 들어갑니다.
...
![](/assets/images/posts/%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%9D%BC%EB%A9%B4-seo%EB%8A%94-%ED%95%B4%EB%B4%90%EC%95%BC%EC%A7%80/%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA%202026-02-12%20%E1%84%8B%E1%85%A9%E1%84%92%E1%85%AE%207.39.43.png)
...
이 둘의 차이는 **메타데이터가 정적인지 동적인지의 차이**입니다.&#x20;

저는 글 본문 페이지에 `/posts/[slug]` 형태의 라우트를 사용하기 때문에 글 본문의 페이지 파일에서 정적으로 메타데이터를 결정할 수 없습니다. 이 경우에 `metadata` 객체가 아니라 `generateMetadata`를 사용하면 각 게시글의 정보를 불러와 동적으로 메타데이터를 생성할 수 있습니다.

만약 메타데이터를 설정하지 않은 페이지는 기본적으로 **상위 라우트의 메타데이터를 상속**받습니다. 그래서 앱 루트 라우트 혹은 레이아웃 파일에서 기본 설정을 해두고, 필요한 라우트에만 다시 설정해주면 편합니다.
...
캐노니컬(canonical) 태그는 동일하거나 거의 동일한 콘텐츠를 가리키는 여러 URL 중에서 **검색 엔진이 대표로 인식해야 할 URL을 지정하는 태그**입니다.
...
위와 같이 설정하면 `/posts` 페이지를 기준으로 `<link rel="canonical">` 태그가 자동으로 생성되며, 쿼리 스트링이 붙은 URL들은 검색 엔진 관점에서 모두 `/posts`의 변형으로 인식되어 색인과 평가 기준이 하나의 URL로 통합됩니다.
...
<Callout variant="info">
  기존의 robots.txt와 별개로 메타데이터에서 작성할 수 있는 [robots 속성](https://nextjs.org/docs/app/api-reference/functions/generate-metadata#robots)도 존재합니다. robots.txt가 사이트 전체에 대한 크롤링 정책을 설정한다면, \
  메타데이터의 robots 속성은 **페이지별 색인 여부와 링크 추적 여부를 설정**한다는 점에서 다릅니다.
...
<Callout variant="info">
  하나의 사이트맵에 들어갈 수 있는 URL의 개수는 최대 50,000개입니다. 만약 URL이 매우 많다면, [Next.js에서 제공하는 다중 사이트맵 생성 방식](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/sitemap#generating-multiple-sitemaps)을 이용해 사이트맵을 여러 개로 나누어 만들 필요가 있습니다.
</Callout>
...
![](/assets/images/posts/%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%9D%BC%EB%A9%B4-seo%EB%8A%94-%ED%95%B4%EB%B4%90%EC%95%BC%EC%A7%80/%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA%202026-02-12%20%E1%84%8B%E1%85%A9%E1%84%92%E1%85%AE%207.38.05.png)
...
저는 동적 방식으로 대표 이미지를 설정해주었는데, `opengraph-image.tsx` 파일을 만들고 Next.js의 `Image` 함수와 `ImageResponse`를 사용하면 대표 이미지를 생성할 수 있습니다. 대표 이미지의 메타데이터를 설정하려면, `generateImageMetadata` 함수를 사용하면 됩니다.
...
![](/assets/images/posts/%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%9D%BC%EB%A9%B4-seo%EB%8A%94-%ED%95%B4%EB%B4%90%EC%95%BC%EC%A7%80/%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA%202026-02-12%20%E1%84%8B%E1%85%A9%E1%84%92%E1%85%AE%209.33.13.png)
...
<Columns>
  <Column>
    ![](/assets/images/posts/%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%9D%BC%EB%A9%B4-seo%EB%8A%94-%ED%95%B4%EB%B4%90%EC%95%BC%EC%A7%80/%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA%202026-02-12%20%E1%84%8B%E1%85%A9%E1%84%92%E1%85%AE%2011.13.27.png)
  </Column>

  <Column>
    ![](/assets/images/posts/%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%9D%BC%EB%A9%B4-seo%EB%8A%94-%ED%95%B4%EB%B4%90%EC%95%BC%EC%A7%80/%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA%202026-02-12%20%E1%84%8B%E1%85%A9%E1%84%92%E1%85%AE%2011.15.41.png)
  </Column>
</Columns>
...
![](/assets/images/posts/%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%9D%BC%EB%A9%B4-seo%EB%8A%94-%ED%95%B4%EB%B4%90%EC%95%BC%EC%A7%80/%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA%202026-02-12%20%E1%84%8B%E1%85%A9%E1%84%92%E1%85%AE%2011.25.03.png)
...
![](/assets/images/posts/%EB%B8%94%EB%A1%9C%EA%B7%B8%EB%9D%BC%EB%A9%B4-seo%EB%8A%94-%ED%95%B4%EB%B4%90%EC%95%BC%EC%A7%80/%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA%202026-02-12%20%E1%84%8B%E1%85%A9%E1%84%92%E1%85%AE%2011.32.47.png)
...
llms.txt는 <u>아직 공식 표준으로 확정된 규격은 아니며</u>, AI 모델이나 관련 크롤러가 **사이트의 구조와 맥락을 이해할 수 있도록 정보를 정리해두는 용도**로 제안된 파일입니다.
...
후, 이렇게 길었던 SEO 작업이 끝났습니다. 그동안 UI 개발에만 치중해왔는데, 결국 내가 만든 페이지가 누군가에게 닿기 위해서는 이런 설정들이 필요하다는 것을 알게 되는 시간이었습니다.
