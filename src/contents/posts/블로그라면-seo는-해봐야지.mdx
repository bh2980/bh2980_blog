...
예를 들어 제 블로그 페이지는 category로 필터링을 할 수 있도록 category라는 쿼리 스트링을 가질 수 있습니다.

* bh2980.dev/posts
* bh2980.dev/posts?category=development

하나의 콘텐츠에 대해 쿼리 스트링이나 필터링 파라미터 등으로 여러 URL이 생성되는 경우, 이 중 어떤 URL을 기준으로 색인할지를 명확히 지정하는 데 사용됩니다.
