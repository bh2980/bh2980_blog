...
RSS는 구독자를 위한 기능이지 직접적으로 SEO에 영향을 미치는 기능은 아닙니다만, <Tooltip content="공식적인 새 글 감지 방법은 sitemap.xml">일부 검색 엔진은 보조적으로 RSS를 통해 새 글을 감지하기도 하기 때문에</Tooltip> 같이 해주면 좋습니다.
