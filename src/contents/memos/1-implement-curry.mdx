...
구성은 괜찮고, “선행 지식”은 **커리 구현에 실제로 쓰는 포인트만** 짧게 정리하면 충분합니다. 아래처럼 채워 넣으면 바로 본문에 연결됩니다.
...
<Collapsible>
  <Code codeblock={{"lang":"typescript","value":"function curry(fn) {\n  return function curried(...args){\n    if(args.length >= fn.length){\n      return fn.call(this, ...args);\n    }\n\n    return curried.bind(this, ...args)\n  }\n}"}} />
</Collapsible>
