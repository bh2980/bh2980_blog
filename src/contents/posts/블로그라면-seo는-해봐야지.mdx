...
<Callout variant="info">
  하나의 사이트맵에 들어갈 수 있는 URL의 개수는 최대 50,000개입니다. 만약 URL이 매우 많ㅎ다면, [Next.js에서 제공하는 다중 사이트맵 생성 방식](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/sitemap#generating-multiple-sitemaps)을 이용해 사이트맵을 여러 개로 나누어 만들 필요가 있습니다.
</Callout>
