...
const icon = (
	<ChevronDownIcon
		className="group-hover:!opacity-100 mb-0.5 inline-block select-none opacity-30 transition group-data-[state=closed]:-rotate-90 group-data-[state=closed]:opacity-80"
		size={15}
	/>
);
