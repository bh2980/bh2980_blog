---
title: 62 - Type Lookup
publishedDateTimeISO: 2026-01-07T09:34:00.000Z
tags:
  - type-challenges
  - typescript
---
...
<Collapsible>
  ```js
  // @mark Tooltip {20-41} content="최소한 type 프로퍼티가 있고 그 값 타입이 T여야 한다는 조건(필터)"
