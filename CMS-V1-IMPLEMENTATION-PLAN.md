...
| M5 | 복제·템플릿·저작 확장 | §12.1-4 | 복제·코드 정의 템플릿 3종·필드/블록 확장 예제가 저장·재열기를 보존한다 |
| M6 | 이전·내보내기 검수 | §12.1-4 | 내보내기·시험 이전·전편 왕복 검수가 전환 차단 이슈를 분류한다 |
| M7 | 블로그 연결 | §12.1-5 | 공개 조회가 DB 공개본만 쓰고, 기존 49편 검수 보고서가 있으며, Keystatic 제거 준비와 전환 승인을 사용자에게 맡긴다 |
...
종료 조건: F13 복제·템플릿과 F07 확장 예제. 관심사는 저작 확장 하나로 한정한다.
