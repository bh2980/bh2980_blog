...
OpenGraph에는 중요한 항목이 하나 더 남아있습니다. 바로 대표 이미지인데요. 대표 이미지 역시 [정적 방식](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/opengraph-image#image-files-jpg-png-gif)과 동적 방식 중 필요한 방식으로 설정할 수 있습니다. 저는 동적 방식으로만 설정했기 때문이 이 방식을 위주로 설명하겠습니다.
